...
export const FavoriteStoreContext = createContext<FavoriteStoreApi | undefined>(
  undefined
);
...
export const useFavoriteStore = <T,>(
  ...
  if (!favoriteStoreContext) {
    throw new Error(
      `useFavoriteStore must be used within FavoriteStoreProvider`
    );
  }
